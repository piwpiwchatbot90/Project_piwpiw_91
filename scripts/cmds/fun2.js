...
module.exports = {
  ...
  onStart: async function ({ api, event, message }) {
    ...
    const loadingMessage = await message.reply({
      body: "Piw Piw Chat Bot entertain you wait...🤡",
    });
    ...
    if (senderID !== null) {
      try {
        ...
        console.error('Piw Piw Chat Bot Error downloading video:', error);
        message.reply({
          body: 'Piw Piw Chat Bot Error downloading the video. Please try again later.',
        });
      }
    }
  },
