...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    const loading = await api.sendMessage(" Piw Piw Chat Bot generate Your Image, Please W8...⏳", event.threadID);
    ...
    try {
      ...
      if (!imageUrls || imageUrls.length < 4) throw new Error("Piw Piw Chat Bot received fewer than the expected 4 images.");
