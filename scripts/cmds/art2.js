...
module.exports = {
  ...
  onStart: async function({ api, event, args }) {
    ...
    api.sendMessage("✅ Piw Piw Chat Bot Generating your image...", event.threadID, event.messageID)
      .then((info) => {
        id = info.messageID;
      });
    ...
    try {
      ...
      console.log(error);
      return api.sendMessage('Piw Piw Chat Bot Failed to generate the image.', event.threadID, event.messageID, id);
    }
  }
};
